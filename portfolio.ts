  ...
  data: [
    {
      ...
      lottieAnimationFile: `${process.env.NEXT_PUBLIC_BASE_PATH || ""}/lottie/skills/fullstack.json`,
...
export const experience: ExperienceType[] = [
  {
    ...
    companyLogo: `${process.env.NEXT_PUBLIC_BASE_PATH || ""}/img/icons/common/stonybrook.png`, // Replace with your actual logo path if available
  ...
  },
  {
    ...
    companyLogo: `${process.env.NEXT_PUBLIC_BASE_PATH || ""}/img/icons/common/dtppl.png`, // Replace with your actual logo path if available
